...
from wstunnel.daemon import wstuncltd, wstunsrvd, Daemon, main
...
class WSTunnelClientDaemonTestCase(DaemonTestCase):
    ...
    def setUp(self):
        ...
        self.daemon = wstuncltd(self.tun_conf)
        self.daemon.hush = lambda **kwargs: 0
...
class WSTunnelServerDaemonTestCase(DaemonTestCase):
    ...
    def setUp(self):
        ...
        self.daemon = wstunsrvd(self.tun_conf)
        self.daemon.hush = lambda **kwargs: 0
...
class MainTestCase(unittest.TestCase):
    ...
    def test_wstuncltd(self):
        ...
        with self.assertRaises(SystemExit) as sysexit:
            main(parser=None, name="wstuncltd")
        self.assertEqual(sysexit.exception.code, 0)
    ...
    def test_wstunsrvd(self):
        ...
        with self.assertRaises(SystemExit) as sysexit:
            main(parser=None, name="wstunsrvd")
        self.assertEqual(sysexit.exception.code, 0)
